...
__align(32) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((at(0x60000000)));					//外部SRAM内存池


//内存管理表
uint16_t mem1mapbase[MEM1_ALLOC_TABLE_SIZE];													//内部SRAM内存池MAP
uint16_t mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(0x60000000+MEM2_MAX_SIZE)));	//外部SRAM内存池MAP
